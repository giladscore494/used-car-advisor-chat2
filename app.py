...
def ask_gpt_models(user_answers):
    prompt = f"""
אתה עוזר מומחה לרכבים בישראל.אתה עוזר מומחה לרכבים בישראל.
...
חוקי היגיון מחירים:
- רכב ישן (2005–2010, עממי כמו Toyota Corolla / Hyundai Getz) כיום 5,000–40,000 ₪.
- רכב 2011–2015, עממי → 20,000–60,000 ₪.
- משפחתי 2016–2020 → 40,000–120,000 ₪.
- משפחתי 2021+ → 70,000–180,000 ₪.
- יוקרה 2010–2015 → 60,000–200,000 ₪.
- יוקרה 2016+ → 150,000–500,000 ₪.
- אין להציע רכב חדש לגמרי מתחת ל־50,000 ₪.
- אין להציע רכב משנת 2005 ומטה במחיר מעל 100,000 ₪.
